...
def verify_gameplay_ui_polish() -> None:
    ...
    required = {
        ...
        "anchor stop has shader capture effect": "play_anchor_capture(grid_pos, gravity_direction)" in player and "func play_anchor_capture" in level_manager and "ANCHOR_CAPTURE_SHADER" in level_manager,
        "anchor capture uses independent shader materials": "ShaderMaterial.new()" in level_manager and "anchor.material = material" in level_manager and "shader_parameter/capture_amount" in level_manager,
        "anchor capture shader exists": "assets/shaders/anchor_capture_pulse.gdshader" in level_manager and (ROOT / "assets/shaders/anchor_capture_pulse.gdshader").exists(),
